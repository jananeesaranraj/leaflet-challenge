...
function techPlates(myMap, controlLayer) {
    ...
    d3.json(platesUrl).then(function (data) {
        ...
        controlLayer.addOverlay(plates,"Techno Plates").addTo(myMap)
    })
...
function createMap(earthquakes) {
    ...
    var controlLayer = L.control.layers(baseMaps, overlays, {
        collapsed: false
    }).addTo(myMap);
